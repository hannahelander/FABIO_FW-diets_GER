...
# How to use the Y-matrix when there are no products written !???


## Status Quo-Diets are supply minus food waste (compare with bottom-up data?)
...
############ Aggregate supply data per Diet.Group ##################
...
MAX_values <- c(7.30, 7.56, 167.49, 0, 9.39, 11.47,91.25, 0, 31.29, 113.15, 38.82, 36.91, 0, 26.67, 107.18)
