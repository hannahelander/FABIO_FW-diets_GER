...
# color_values_hex = c("#d4a269",rgb(128, 77, 21,   maxColorValue = 255), # need to adapt order!
#                      rgb(0, 61, 25, 0 , maxColorValue = 255),rgb(41, 122, 74,   maxColorValue = 255),
#                      rgb(2, 38, 54,  maxColorValue = 255), rgb(39, 87, 107,   maxColorValue = 255),
#                      rgb(212, 127, 106,  maxColorValue = 255), rgb(170, 78, 57,  maxColorValue = 255),
#                      rgb(85, 16, 0,  maxColorValue = 255),rgb(107, 117, 159,  maxColorValue = 255))
# 
# color_values = c('rgba(212, 162, 106, 0.6)','rgb(128, 77, 21, 0.6)', 
#                  'rgb(0, 61, 25, 0 , 0.6)', 'rgb(41, 122, 74,  0.6)' , 'rgb(2, 38, 54, 0.6)', 
#                  'rgb(39, 87, 107,  0.6)', 'rgb(212, 127, 106,  0.6)', 'rgb(170, 78, 57,  0.6)',
#                  'rgb(85, 16, 0,  0.6)', 'rgb(107, 117, 159, 0.6)')
