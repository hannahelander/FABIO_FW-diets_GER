...
### Choose scenario
Y_tot <- Y_EATveg_minW
waste <- read.csv2(file = "data/waste_data_minimum.csv") # must be consistent with scenario (note that for SQ the diet depend on wastage levels)
...
write.csv2(supply_chain_Y, file = "output/supply_chain_mass_EATveg_minW.csv")
